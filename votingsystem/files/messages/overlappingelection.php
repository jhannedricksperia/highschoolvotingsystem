...
<html>
<head>
    <title>Overlapping Elections</title>
...
<body>
            ...
            <div class="topnav">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="../user/check_vote_status.php">Vote Now</a>  
    ...
    <div class="centerMain">
        <div class="message-container">
            <h1 class="message-title">Multiple Active Elections</h1>
            <p class="message-text">
                There are currently multiple active elections with overlapping schedules. 
                Please contact the administrator to resolve this issue.
            </p>
            <a href="../user/home.php" class="button">Return to Home</a>
        </div>
    </div>
