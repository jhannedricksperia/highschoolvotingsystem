...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../files/maincss/main.css">
    <link rel="stylesheet" type="text/css" href="../../files/user/user.css">
    <style>
        .message-container {
...
<body>
    <header>
        <div class="header">
            ...
            <div class="topnav">
                <a href="../../files/user/home.php">Home</a>
                <div class="dropdown">
                    <a class="active">Vote</a>
                    <div class="dropdown-content">
                        <a href="../../files/user/check_vote_status.php">Vote Now</a>  
                        <a href="../../files/user/votereceipt.php">Vote Receipt</a>
                        <a href="../../files/user/agendas.php">Agendas</a>
                        <a href="../../files/user/results.php">Results</a>
                    </div>
                </div>
                <div class="dropdown">
                    <a>Account</a>
                    <div class="dropdown-content">
                        <a href="../../files/user/accountmanagement.php">Manage</a>
    ...
    <div class="centerMain">
        <div class="message-container">
            ...
            <h1 class="message-title">Already Voted</h1>
            <p class="message-text">
                It looks like you've already voted.<br>
                Thank you for participating in this election!
            </p>
            <a href="../../files/user/home.php" class="back-button">Back to Home</a>
        </div>
    </div>
