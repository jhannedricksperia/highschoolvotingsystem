...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $updateQuery = "UPDATE adminloggedrecord SET LoggedIn = ?, LoggedOut = ?, ModifyBy = ?, ModifyDate = ? WHERE LoggedID = ?";
...
$query = "SELECT al.*, a.Username AS AdminUsername 
...
if ($result->num_rows === 0) {
    header("Location: adminloggedmanagement.php");
    exit();
}
...
<html>
<head>
    <title>Edit Admin Logged Record</title>
...
<body>
    ...
    <div class="edit-container">
        <h2>Edit Admin Logged Record</h2>
        ...
        <form method="POST" action="">
            ...
            <label>Admin Username:
                <input type="text" value="<?php echo htmlspecialchars($loggedRecord['AdminUsername'] ?? 'N/A'); ?>" disabled>
            </label>
            ...
            <div class="form-actions">
                <a href="adminloggedmanagement.php" class="btn btn-cancel">Cancel</a>
