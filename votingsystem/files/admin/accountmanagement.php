...
if (isset($_GET['success'])) {
    switch($_GET['success']) {
        case '1': $successMessage = "Password updated successfully!"; break;
        case '2': $successMessage = "Account information updated successfully!"; break;
        default: $successMessage = "Operation completed successfully!"; break;
    }
}
if (isset($_GET['error'])) {
    switch($_GET['error']) {
        case '1': $errorMessage = "Failed to update password. Please try again."; break;
        case '2': $errorMessage = "Current password is incorrect."; break;
        case '3': $errorMessage = "New password cannot be the same as current password."; break;
        case '4': $errorMessage = "Failed to update account information."; break;
        ...
        <div class="form-center-content">
            <form method="POST" action="account_process.php" class="account-form">
                ...
                <div>
                    ...
                    <input type="text" id="AccountID" name="AccountID" value="<?php echo htmlspecialchars($account['AdminID']); ?>" disabled>
                </div><br>
